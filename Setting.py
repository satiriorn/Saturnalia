...
def SettingTranslate(update,context):
    ...
    if update.callback_query.message.chat.type == "private":
        DB.DataBase.VerificationLanguage(badge.DB, update.callback_query.message.chat_id, badge.b[update.callback_query.data])
    else:
        DB.DataBase.VerificationLanguage(badge.DB, update.callback_query.message.chat_id, badge.b[update.callback_query.data])
...
def LanguageBot(update, context):
    ...
    if badge.CommandLangBot != True:
        ...
        return
    if update.callback_query.message.chat.type == "private":
        DB.DataBase.VerificationLanguage(badge.DB, update.callback_query.message.chat_id, badge.b[update.callback_query.data], False)
    else:
        DB.DataBase.VerificationLanguage(badge.DB,  update.callback_query.message.chat_id, badge.b[update.callback_query.data], False)
    context.bot.edit_message_text(chat_id=update.callback_query.message.chat_id, text=answer["11"], message_id=update.callback_query.message.message_id)
