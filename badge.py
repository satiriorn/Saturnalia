...
ShevchenkoStyle = ["""Мова творить націю та державу, вона дає людині крила і силу, але ми маємо перестати за то вмирати, а навчитися вбивати за свою мову.""", """Kохайтеся та не з москалями"""]