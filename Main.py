import Quotes, start, help, weather, Evtuh, text,  CreateVoice, DogAndCat, InlineQuery, os, Meme, Youtube, Translate, DB, badge, Keyboard, Setting, Rest, Cut, File
...
def main():
    ...
    cute_command_handler = CommandHandler("Cut", Cut.CutAudio)
